...
import HowItWorksItem from "@/components/landing/HowItWorksItem";
import { PrimaryLink } from "@/components/landing/PrimaryLink";
import {
  AccentText,
  SectionContainer,
  SectionDescription,
  ...
  return (
    <div className="bg-primary-contr flex flex-col items-center justify-center">
      <div className="border-divider flex w-full flex-1 items-center border-b px-6 py-4">
        <img className="h-8" src="/InLectureLogoWithIcon.svg" alt="InLecture" />
      </div>
      ...
      <SectionContainer>
        ...
        <SectionDescription>
          InLecture isn&apos;t a static chatbot. It knows what slide you&apos;re
          on, what your professor just said, and how today&apos;s content
          connects to Week 1.
        </SectionDescription>
      ...
      <SectionContainer contrast>
        <SectionHeading contrast>How it Works</SectionHeading>
        <SectionSubheading contrast>
          Three layers of context, <AccentText contrast>one</AccentText>{" "}
          companion
        </SectionSubheading>
        <SectionDescription contrast>
      ...
      <SectionContainer center contrast>
        <SectionHeading center contrast>
          Get Started
        </SectionHeading>
        <SectionSubheading center contrast>
          Ready to make every lecture <AccentText contrast>count</AccentText>?
        </SectionSubheading>
        <SectionDescription center contrast>
      ...
      <div className="bg-footer-bg flex w-full items-start justify-between px-6 py-4 sm:items-center">
        <div className="pt-1">
          <img src="/InLectureWordmark.svg" alt="InLecture" className="w-28" />
        </div>
